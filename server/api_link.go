...
func (s *ApiServer) LinkFacebookInstantGame(ctx context.Context, in *api.AccountFacebookInstantGame) (*emptypb.Empty, error) {
	...
	err := LinkFacebookInstantGame(ctx, s.logger, s.db, s.config, s.socialClient, userID, in.SignedPlayerInfo)
	if err != nil {
		return nil, err
	}
...
func (s *ApiServer) LinkGameCenter(ctx context.Context, in *api.AccountGameCenter) (*emptypb.Empty, error) {
	...
	err := LinkGameCenter(ctx, s.logger, s.db, s.socialClient, userID, in.PlayerId, in.BundleId, in.TimestampSeconds, in.Salt, in.Signature, in.PublicKeyUrl)
	if err != nil {
		return nil, err
	}
...
func (s *ApiServer) LinkGoogle(ctx context.Context, in *api.AccountGoogle) (*emptypb.Empty, error) {
	...
	err := LinkGoogle(ctx, s.logger, s.db, s.socialClient, userID, in.Token)
	if err != nil {
		return nil, err
	}
